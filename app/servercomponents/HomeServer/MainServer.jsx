...
import HeroDevices from "../../components/Home/Main";
import Link from "next/link";

export default function HeroSection({ lang = "fa" }) {
  const slides = [
    {
      desktop: "/media/shot/darktube.webp",
      mobile: "/media/shot/example.webp",
      title: "مدرنترین و بهینه ترین وبسایت دلخواه شما  ",
      description: "با پشتیبانی مادام العمر ",
      technologies: [
        "بالاترین امتیاز ",
        "پنل اختصاصی",
        "کدنویسی حرفه ای",
    ...
    {
      desktop: "/media/shot/imdb.webp",
      title: "تجربه منحصر به فرد",

      tablet: "/media/shot/imdb.webp",
      mobile: "/media/shot/imdbmob.webp",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
          ...
          <div className="space-y-6 md:space-y-8 lg:space-y-12 text-right order-2 lg:order-1">
            ...
            <div className="space-y-4 md:space-y-6">
              <h1 className="text-xl sm:text-xl md:text-2xl lg:text-3xl font-black text-gray-900 leading-tight">
                طراحی و توسعه ی وبسایت حرفه‌ای در کوردستان و ایران
              </h1>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                {slides[0].technologies.map((tech, index) => (
                  <span
                    key={`tech-${index}`}
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-3 md:pt-4">
              ...
              <Link
                ...
                className="flex-1"
              >
                <button className="w-full px-6 md:px-8 py-3 md:py-4 bg-white border-2 border-[#1e40af] text-[#1e40af] font-bold rounded-xl md:rounded-2xl hover:bg-[#1e40af]/5 transition-colors duration-300">
          ...
          {/* Right Column - Devices Showcase with Slider */}
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            <HeroDevices slides={slides} />
          </div>
        </div>
      </div>
    </section>
